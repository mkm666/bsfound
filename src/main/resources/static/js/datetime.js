...
function changedatetime(objectname)//将日期格式规范化成 yyyy-mm-dd hh:mm:ss
{
    ...
    console.log(curtext)
    year=curtext.substring(0,4);
    month=curtext.substring(5,7);
    day=curtext.substring(8,10);
    minute=curtext.substring(11,13);
    hour=curtext.substring(14,16);
    second=curtext.substring(17,19);
